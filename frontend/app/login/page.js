...
export default function Login() {
    ...
    return (
        <main className="min-h-screen flex items-center justify-center bg-slate-900 bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-950 p-6">
            <div className="max-w-4xl w-full flex flex-col md:flex-row bg-white rounded-3xl overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)]">
                {/* Branding Side */}
                <div className="md:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-600 p-12 text-white flex flex-col justify-center relative overflow-hidden">
                ...
                <div className="md:w-1/2 p-12 md:p-16 flex flex-col justify-center bg-white relative">
                    ...
                    <p className="text-gray-500 mb-8">Manage your S3-compatible buckets</p>
                    ...
                    <p className="text-center mt-10 text-gray-500 font-medium text-sm">
                        Don't have an account? <Link href="/register" className="text-blue-600 hover:text-blue-800 font-bold transition-colors">Create one now</Link>
                    </p>
                </div>
            </div>
        </main>
